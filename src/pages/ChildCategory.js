...
//       prevCheck.includes(categoryName)
//         ? prevCheck.filter((name) => name !== categoryName)
//         : [...prevCheck, categoryName]
//     );
//   };
//   return (
//     <>
...
//                       isChecked={isCheck.includes(category)}
//                       handleClick={() => handleSelectAll(category)}
//                     />
//                   </TableCell>
//                   <TableCell>{category}</TableCell>
//                   <TableCell className="text-center">
//                     {category.published ? "show" : "hide"}
//                   </TableCell>
//                   <TableCell className="text-right">
